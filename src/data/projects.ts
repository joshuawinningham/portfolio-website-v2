...
export const projects: Project[] = [
	{
		...
		highlights: [
			...
			"Built saved audits, AI citation matrices, competitor comparisons and paste-ready technical fixes on Supabase/PostgreSQL with Drizzle ORM.",
			"Implemented Stripe billing and Inngest background workflows, then extended the product with six public readiness tools.",
		],
		tech: [
			"Next.js 16",
			"TypeScript",
